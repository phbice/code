...
int BaseWindow::run()
{
    ...
    // this->hwnd = CreateWindowEx(0, this->szAppName, this->szWindowName, WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, 500, 500, (HWND)NULL, (HMENU)NULL, this->hInstance, this);
    ...
    WPARAM wParam, LPARAM lParam)
{
    ...
    if (uMsg == WM_CREATE)
    {
        ...
        return TRUE;  // 一定要返回 TRUE ，否则 CreateWindowEx 返回 NULL ，不会创建窗口
    }
    else
    {
